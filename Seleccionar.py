...
#    elif (txtEliminar.get()!=creditos[i].codigo):            
...
def Mostrar():
    ...
    txtmostrarnombre=ttk.Entry(ventaamostrar,font="Cambria 22")
    txtmostrarnombre.place(x="185",y="55",width="600",height="30")
    #txtmostrarnombre.config(state="disabled")
    txtmostrarprerrequisito=ttk.Entry(ventaamostrar,font="Cambria 22")
...
def AgregaCurso():
    ...
    if (txtcode.get()!= "" and txtname.get()!="" and txtprerequest.get()!="" and txtsemester.get()!="" and txtoption.get()!="" and txtcredits.get()!="" and txtestate.get()!=""):
        ...
        messagebox.showinfo("Warning","No se cargó ningun Curso")
...
def Edicion():
    ...
    global txteditarcreeditos
    global txteditarestado
    if (txteditarcodigo.get()!= "" and txteditarnombre.get()!="" and txteditarprerrequisito.get()!="" and txteditarsemestre.get()!="" and txteditaropcionalidad.get()!="" and txteditarcreeditos.get()!="" and txteditarestado.get()!=""):
        ...
        messagebox.showinfo("Warning","No Editó el Curso")
